...
void ImageModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->loadingFinished((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->batchLoaded((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ImageModel::*)(int )>(_a, &ImageModel::loadingFinished, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ImageModel::*)(int )>(_a, &ImageModel::batchLoaded, 1))
            return;
    }
}
...
// SIGNAL 0
void ImageModel::loadingFinished(int _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void ImageModel::batchLoaded(int _t1)
{
